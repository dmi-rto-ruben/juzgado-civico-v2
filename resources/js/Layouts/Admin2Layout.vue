...
//import menuHeader from '@/../assets/images/menu-heade.jpg'
</script>
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="index.html" class="main-logo flex shrink-0 items-center">
                            <img class="ml-[5px] w-8 flex-none" src="https://juzgado-civico.test/assets/images/logo.svg" alt="image" />
        ...
        <div class="main-content flex min-h-screen flex-col">
                ...
                <div class="shadow-sm">
                    <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="https://juzgado-civico.test/assets/images/logo.svg" alt="image" />
                                <span
                            ...
                            <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                <a href="#" class="group relative" @click="toggle()">
                                        ...
                                        ><img
                                            ...
                                            src="https://juzgado-civico.test/assets/images/user-profile.jpeg"
                                            alt="image"
                                        /></span>
                                </a>
                                <ul
                                ...
                                >
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <img class="h-10 w-10 rounded-md object-cover" src="https://juzgado-civico.test/assets/images/user-profile.jpeg" alt="image" />
                                            </div>
            ...
            <div class="mt-auto p-6 text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">
                © <span id="footer-year">2025</span>. Ayuntamiento All rights reserved.
            </div>
            <!-- end footer section -->
        </div>
    </div>
